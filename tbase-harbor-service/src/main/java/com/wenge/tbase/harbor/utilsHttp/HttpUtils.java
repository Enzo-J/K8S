package com.wenge.tbase.harbor.utilsHttp;
...
public class HttpUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String result = doPost("http://hongqi.wengetech.com:9080:port/sprint/rest/api/workflow/stories/media/0/createFile", jsonObject);
